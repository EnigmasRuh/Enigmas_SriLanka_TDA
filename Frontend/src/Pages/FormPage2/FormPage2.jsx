        ...
        <div className="font-[Prompt] container  mx-auto " style={{ maxWidth: '843px', maxHeight: "358"}}>
          <div className='container mx-auto px-4' style={{ marginBottom: "40px" }}>
            <div className="flex justify-end" >
              <button style={{ paddingInline: "50px", paddingTop: "20px", paddingBottom: "20px" }} className="hover:bg-none bg-gradient-to-r from-[#5A3111] via-[#D68631] to-[#5A3111] hover:bg-[#D68631] text-white px-6 py-3 rounded-xl flex items-center text-lg" >
                <span>Submit</span>
